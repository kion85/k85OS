...
void k85_run_system_info(void) {
    ...
    while (true) {
        ...
        M5.Display.setCursor(10, y); M5.Display.printf("%s %s  [%d/%d]", K85_FW_NAME, K85_FW_VERSION, page + 1, page_count); y += 12;
        y += 6;
        ...
        M5.Display.print("B=page A+B=back");
